...
\begin{evidence}[blue]
\textbf{It transfers to \emph{other} subjects.} Over one year, students taking post-compulsory
mathematics improved at \textbf{conditional reasoning} more than matched literature students ---
with \emph{no instruction in logic at all}.
\evsrc{Attridge \& Inglis, \textit{PLoS ONE} 8(7), 2013.}
\end{evidence}

\pause
\begin{evidence}[orange]
\textbf{It is exactly what AI does \emph{not} hand you.} Given an AI assistant, developers wrote
\alert{less secure} code --- and were \alert{more likely to believe it was secure}. Those who
...
\textbf{It pays.} For the marginal student, \textbf{one extra high-school math course $\Rightarrow$ $\sim$10\% higher earnings}
--- about half the return to an entire year of schooling --- via a shift into more cognitively skilled work.
