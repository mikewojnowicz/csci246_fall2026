...
\officehours{Office Hrs: MW 3-4, Fr 1-2} 
...
%%%%%%%%%%%%%%% TA INFO
\taAname{Madhav Cherupilil}
\taAofficehours{Thurs 3-6pm; Fri AM by appt.}
\taAoffice{Tutoring Center (GH 118)}
\taAemail{m.cherupililsajeev@montana.edu}
\taBname{}
\taBofficehours{}
\taBoffice{}
\taBemail{}
...
%%%%%%%%%%%%%%% TUTOR
\tutorname{Holden Lee}
\tutoremail{holdenhlee123@gmail.com}
\tutorofficehours{Mon-Fri 3:30-5:30. By appointment.  Book \href{https://montana.campus.eab.com/pal/QF53UwFsl3}{here}. Sessions are \underline{free!}}
...
The Friday weekly quizzes will cover group exercises \underline{and the readings} from a batch of three class meetings (that week's Mon., and the previous Wed. and Fri.) 
...
\hline
Fri & Oct 2 & Proof Review & \\
Mon & Oct 5 & Proof Quiz Retake (Optional); Midterm Review  & \\
Wed & Oct 7 & MIDTERM EXAM & \\
\hline
\multicolumn{4}{l}{\textbf{\textcolor{myCOLOR}{\large MODULE 4: More proof}}} \\
\hline

Fri & Oct 9 & Contradiction & Sec 20 \\
Mon & Oct 12 & Smallest counterexample & Sec 21 \\
Wed & Oct 14 & Induction & Sec 22  \\
Fri & Oct 16 & Recurrence  & Sec 23 \\
Mon & Oct 19 & Multiple Proofs  & Hamkins Ch. 2\\
\hline
\multicolumn{4}{l}{\textbf{\textcolor{myCOLOR}{\large MODULE 5: Functions and Big O notation}}} \\
\hline
Wed &  Oct 21  & Functions & Sec 24 \\
Fri &  Oct 23  & Real-valued functions & Epp Sec 11.1 \\
Mon &  Oct 26 & Big O Notation & Epp Sec 11.2 \\
