...
\begin{itemize}
	...
	\item \textbf{During class:} \textit{Attend class.} This allows you to participate in the mini-lecture discussions and group activities.
	\item \textbf{After class:} \textit{Finish working through the group exercises.}   Solutions to group exercises are posted within an hour after class.  During class time, you will probably just get the gist of some problems. After class, you should 
	\begin{enumerate}
...
Fri &  Sept 11 & Multiple Proofs  & Hamkins Ch. 2\\
\hline
\multicolumn{4}{l}{\textbf{\textcolor{myCOLOR}{\large MODULE 2: Discrete Collections }}} \\
\hline

Mon &  Sept 14 & Lists & Sec 8 \\
Wed &  Sept 16 & Factorial & Sec 9 \\
Fri &  Sept 18 & Sets & Sec 10 \\
Mon &  Sept 21 & Quantifiers &  Sec 11  \\
Wed &  Sept 23 & Operations on Sets & Sec 12 \\
\hline
\multicolumn{4}{l}{\textbf{\textcolor{myCOLOR}{\large MODULE 3: Counting and relations}}} \\
\hline
Fri & Sept 25 & Relations & Sec 14 \\
Mon &  Sept 28 & Equivalence Relations & Sec 15 \\
Wed & Sept 30 & Partitions & Sec 16 \\
Fri & Oct 2 & Binomial Coefficients (Combinations) & Sec 17  \\
\hline
\multicolumn{4}{l}{\textbf{\textcolor{myCOLOR}{\large MIDTERM}}} \\
\hline
Mon & Oct 5 & Review for Midterm & \\
